...
class _SponsersScreenState extends State<SponsersScreen>
  ...
  Widget _buildPartnersTab() {
    final partners = [
      ...
      {'name': 'Pharco - ', 'logo': 'assets/logos/pharco-yas.png'},
      {'name': 'Pharco - ', 'logo': 'assets/logos/pharco-sher.png'},
      ...
      {'name': 'Boehringer Ingelheim', 'logo': 'assets/logos/boehringer.png'},
      {'name': 'Pectus Lab', 'logo': 'assets/logos/pectus-lab.png'},
      {'name': 'Advocure', 'logo': 'assets/logos/advocure.png'},
      {'name': 'Eltech Group', 'logo': 'assets/logos/eltech.png'},
      {'name': 'Medtronic', 'logo': 'assets/logos/medtronic.png'},
      {'name': 'EGMED', 'logo': 'assets/logos/egmed.png'},
